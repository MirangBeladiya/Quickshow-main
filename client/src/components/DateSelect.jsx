...
const DateSelect = ({ dateTime, id }) => {
  ...
  return (
    <div id="dateSelect" className="pt-30">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/20 border border-primary/20 rounded-lg">
        ...
        <button onClick={onBookHandler} className="bg-primary hover:bg-primary-dull px-8 py-2 mt-6 rounded transition-all cursor-pointer active:scale-95">
          Book Now
        </button>
      </div>
    </div>
